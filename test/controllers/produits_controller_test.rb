...
class ProduitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produit" do
    assert_difference("Produit.count") do
      post produits_url, params: { produit: { category_id: @produit.category_id, name: @produit.name, price: @produit.price, quantity: @produit.quantity, stock: @produit.stock } }
    end
  ...
  test "should update produit" do
    patch produit_url(@produit), params: { produit: { category_id: @produit.category_id, name: @produit.name, price: @produit.price, quantity: @produit.quantity, stock: @produit.stock } }
